...
export const UserProfileFindUniqueOrThrowSchema: z.ZodType<Prisma.UserProfileFindUniqueOrThrowArgs> = z.object({ select: UserProfileSelectObjectSchema.optional(), include: UserProfileIncludeObjectSchema.optional(), where: UserProfileWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.UserProfileFindUniqueOrThrowArgs>;

export const UserProfileFindUniqueOrThrowZodSchema = z.object({ select: UserProfileSelectObjectSchema.optional(), include: UserProfileIncludeObjectSchema.optional(), where: UserProfileWhereUniqueInputObjectSchema }).strict();