...
const makeSchema = () => z.object({
  userId: z.string().optional()
        ...
        const singles: string[] = ["userId"] as string[];
...
export const UserProfileWhereUniqueInputObjectSchema: z.ZodType<Prisma.UserProfileWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.UserProfileWhereUniqueInput>;
export const UserProfileWhereUniqueInputObjectZodSchema = makeSchema();
