...
import { TenantMemberTenantIdUserIdCompoundUniqueInputObjectSchema as TenantMemberTenantIdUserIdCompoundUniqueInputObjectSchema } from './TenantMemberTenantIdUserIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  tenantId_userId: z.lazy(() => TenantMemberTenantIdUserIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["tenantId","userId"]] as string[][];
...
export const TenantMemberWhereUniqueInputObjectSchema: z.ZodType<Prisma.TenantMemberWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.TenantMemberWhereUniqueInput>;
export const TenantMemberWhereUniqueInputObjectZodSchema = makeSchema();
