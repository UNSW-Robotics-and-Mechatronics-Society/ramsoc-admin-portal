...
export const TenantMemberFindFirstSelectSchema: z.ZodType<Prisma.TenantMemberSelect> = z.object({
...
export const TenantMemberFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    tenantId: z.boolean().optional(),
    userId: z.boolean().optional(),
    type: z.boolean().optional(),
