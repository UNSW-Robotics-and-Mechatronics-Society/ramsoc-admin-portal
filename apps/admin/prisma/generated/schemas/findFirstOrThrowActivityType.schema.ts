...
export const ActivityTypeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ActivityTypeSelect> = z.object({
...
export const ActivityTypeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    activities: z.boolean().optional(),
...
export const ActivityTypeFindFirstOrThrowSchema: z.ZodType<Prisma.ActivityTypeFindFirstOrThrowArgs> = z.object({ select: ActivityTypeFindFirstOrThrowSelectSchema.optional(), include: ActivityTypeIncludeObjectSchema.optional(), orderBy: z.union([ActivityTypeOrderByWithRelationInputObjectSchema, ActivityTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActivityTypeWhereInputObjectSchema.optional(), cursor: ActivityTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivityTypeScalarFieldEnumSchema, ActivityTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ActivityTypeFindFirstOrThrowArgs>;

export const ActivityTypeFindFirstOrThrowZodSchema = z.object({ select: ActivityTypeFindFirstOrThrowSelectSchema.optional(), include: ActivityTypeIncludeObjectSchema.optional(), orderBy: z.union([ActivityTypeOrderByWithRelationInputObjectSchema, ActivityTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActivityTypeWhereInputObjectSchema.optional(), cursor: ActivityTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivityTypeScalarFieldEnumSchema, ActivityTypeScalarFieldEnumSchema.array()]).optional() }).strict();