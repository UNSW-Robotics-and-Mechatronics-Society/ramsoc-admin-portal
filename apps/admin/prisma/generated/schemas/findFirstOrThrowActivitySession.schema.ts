...
export const ActivitySessionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ActivitySessionSelect> = z.object({
...
export const ActivitySessionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    tenantId: z.boolean().optional(),
    activityId: z.boolean().optional(),
    visibility: z.boolean().optional(),
...
export const ActivitySessionFindFirstOrThrowSchema: z.ZodType<Prisma.ActivitySessionFindFirstOrThrowArgs> = z.object({ select: ActivitySessionFindFirstOrThrowSelectSchema.optional(), include: ActivitySessionIncludeObjectSchema.optional(), orderBy: z.union([ActivitySessionOrderByWithRelationInputObjectSchema, ActivitySessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActivitySessionWhereInputObjectSchema.optional(), cursor: ActivitySessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivitySessionScalarFieldEnumSchema, ActivitySessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ActivitySessionFindFirstOrThrowArgs>;

export const ActivitySessionFindFirstOrThrowZodSchema = z.object({ select: ActivitySessionFindFirstOrThrowSelectSchema.optional(), include: ActivitySessionIncludeObjectSchema.optional(), orderBy: z.union([ActivitySessionOrderByWithRelationInputObjectSchema, ActivitySessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActivitySessionWhereInputObjectSchema.optional(), cursor: ActivitySessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivitySessionScalarFieldEnumSchema, ActivitySessionScalarFieldEnumSchema.array()]).optional() }).strict();