...
export const TenantMemberFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TenantMemberSelect> = z.object({
...
export const TenantMemberFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    tenantId: z.boolean().optional(),
    userId: z.boolean().optional(),
    type: z.boolean().optional(),
