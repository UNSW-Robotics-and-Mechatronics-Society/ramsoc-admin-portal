...
export const ActivitySessionCheckInFindManySelectSchema: z.ZodType<Prisma.ActivitySessionCheckInSelect> = z.object({
...
export const ActivitySessionCheckInFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    tenantId: z.boolean().optional(),
    activitySessionId: z.boolean().optional(),
    memberId: z.boolean().optional(),
...
export const ActivitySessionCheckInFindManySchema: z.ZodType<Prisma.ActivitySessionCheckInFindManyArgs> = z.object({ select: ActivitySessionCheckInFindManySelectSchema.optional(), include: ActivitySessionCheckInIncludeObjectSchema.optional(), orderBy: z.union([ActivitySessionCheckInOrderByWithRelationInputObjectSchema, ActivitySessionCheckInOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActivitySessionCheckInWhereInputObjectSchema.optional(), cursor: ActivitySessionCheckInWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivitySessionCheckInScalarFieldEnumSchema, ActivitySessionCheckInScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ActivitySessionCheckInFindManyArgs>;

export const ActivitySessionCheckInFindManyZodSchema = z.object({ select: ActivitySessionCheckInFindManySelectSchema.optional(), include: ActivitySessionCheckInIncludeObjectSchema.optional(), orderBy: z.union([ActivitySessionCheckInOrderByWithRelationInputObjectSchema, ActivitySessionCheckInOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActivitySessionCheckInWhereInputObjectSchema.optional(), cursor: ActivitySessionCheckInWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivitySessionCheckInScalarFieldEnumSchema, ActivitySessionCheckInScalarFieldEnumSchema.array()]).optional() }).strict();