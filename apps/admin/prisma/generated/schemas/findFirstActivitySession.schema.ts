...
export const ActivitySessionFindFirstSelectSchema: z.ZodType<Prisma.ActivitySessionSelect> = z.object({
...
export const ActivitySessionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    tenantId: z.boolean().optional(),
    activityId: z.boolean().optional(),
    visibility: z.boolean().optional(),
...
export const ActivitySessionFindFirstSchema: z.ZodType<Prisma.ActivitySessionFindFirstArgs> = z.object({ select: ActivitySessionFindFirstSelectSchema.optional(), include: ActivitySessionIncludeObjectSchema.optional(), orderBy: z.union([ActivitySessionOrderByWithRelationInputObjectSchema, ActivitySessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActivitySessionWhereInputObjectSchema.optional(), cursor: ActivitySessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivitySessionScalarFieldEnumSchema, ActivitySessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ActivitySessionFindFirstArgs>;

export const ActivitySessionFindFirstZodSchema = z.object({ select: ActivitySessionFindFirstSelectSchema.optional(), include: ActivitySessionIncludeObjectSchema.optional(), orderBy: z.union([ActivitySessionOrderByWithRelationInputObjectSchema, ActivitySessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActivitySessionWhereInputObjectSchema.optional(), cursor: ActivitySessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivitySessionScalarFieldEnumSchema, ActivitySessionScalarFieldEnumSchema.array()]).optional() }).strict();